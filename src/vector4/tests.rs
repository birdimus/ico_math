...
mod tests {
	...
	fn floor(){	
    	...
    	{
		let a = Vector4::floor(Vector4::new(2.0 * 2147483647.0,-2.0 * 2147483648.0, -0.0, 1.0));
	...
	fn ceil(){	
        ...
        {
		let a = Vector4::ceil(Vector4::new(2.0 * 2147483647.0,-2.0 * 2147483648.0, -0.0, 1.0));
		let b = Vector4::new(0.0,0.0,1.0, 1.0);
		let c = Vector4::copysign(b,a);
        assert_eq!(a.x(), 2.0 * 2147483647.0);
        assert_eq!(a.y(), -2.0 * 2147483648.0);
	...
	fn round(){	
    	...
    	{
		let a = Vector4::round(Vector4::new(2.0 * 2147483647.0,-2.0 * 2147483648.0, -0.0, 1.0));
		let b = Vector4::new(0.0,0.0,1.0, 1.0);
		let c = Vector4::copysign(b,a);
        assert_eq!(a.x(), 2.0 * 2147483647.0);
        assert_eq!(a.y(), -2.0 * 2147483648.0);
	...
	fn floor_to_int(){	
    	...
    	{
		let a = Vector4::floor_to_int(Vector4::new(2.0 * 2147483647.0,-2.0 * 2147483648.0, -0.0, 1.0));
	...
	fn ceil_to_int(){	
    	...
    	{
		let a = Vector4::ceil_to_int(Vector4::new(2.0 * 2147483647.0,-2.0 * 2147483648.0, -0.0, 1.0));
	...
	fn truncate(){	
    	...
    	{
		let a = Vector4::truncate(Vector4::new(2.0 * 2147483647.0,-2.0 * 2147483648.0, -0.1, 1.0));
		let b = Vector4::new(0.0,0.0,1.0, 1.0);
		let c = Vector4::copysign(b,a);
        assert_eq!(a.x(), 2.0 * 2147483647.0);
        assert_eq!(a.y(), -2.0 * 2147483648.0);
