...
impl FloatVector{
	...
	pub fn add(self, v2 : FloatVector) -> FloatVector{	
		unsafe{
			FloatVector{data : _mm_add_ps(self.data, v2.data)}
		}
	}
	...
	pub fn sub(self, v2 : FloatVector) -> FloatVector{	
		unsafe{
			FloatVector{data : _mm_sub_ps(self.data, v2.data)}
		}
	}
	...
	pub fn mul(self, v2 : FloatVector) -> FloatVector{	
		unsafe{
			FloatVector{data : _mm_mul_ps(self.data, v2.data)}
		}
	}
	...
	pub fn div(self, v2 : FloatVector) -> FloatVector{	
		unsafe{
			FloatVector{data : _mm_div_ps(self.data, v2.data)}
		}
	}
	...
	pub fn mul_add(self, v2 : FloatVector, v3 : FloatVector) -> FloatVector{	
		unsafe{
			return FloatVector{data : _mm_fmadd_ps(self.data, v2.data, v3.data)};
		}
	}
	...
	pub fn mul_sub(self, v2 : FloatVector, v3 : FloatVector) -> FloatVector{	
		unsafe{
			return FloatVector{data : _mm_fmsub_ps(self.data, v2.data, v3.data)};
		}
	}
	...
	pub fn neg_mul_add(self, v2 : FloatVector, v3 : FloatVector) -> FloatVector{	
		unsafe{
			return FloatVector{data : _mm_fnmadd_ps(self.data, v2.data, v3.data)};
		}
	}
	...
	pub fn neg_mul_sub(self, v2 : FloatVector, v3 : FloatVector) -> FloatVector{	
		unsafe{
			return FloatVector{data : _mm_fnmsub_ps(self.data, v2.data, v3.data)};
		}
	}
	...
	pub fn and<T : SIMDVector1>(self, v2 : T) -> FloatVector{	
		unsafe{
			FloatVector{data : _mm_and_ps(self.data, v2.data())}
		}
	}
	...
	pub fn or<T : SIMDVector1>(self, v2 : T) -> FloatVector{	
		unsafe{
			FloatVector{data : _mm_or_ps(self.data, v2.data())}
		}
	}
	...
	pub fn andnot<T : SIMDVector1>(self, v2 : T) -> FloatVector{	
		unsafe{
			FloatVector{data : _mm_andnot_ps(self.data, v2.data())}
		}
	}
	...
	pub fn xor<T : SIMDVector1>(self, v2 : T) -> FloatVector{	
		unsafe{
			FloatVector{data : _mm_xor_ps(self.data, v2.data())}
		}
	}
	...
	pub fn abs(self) -> FloatVector{	
		unsafe{
			FloatVector{data :  _ico_abs_ps(self.data)}
		}
	}
	...
	pub fn copysign(self, v2 : FloatVector) -> FloatVector{	
		unsafe{
			FloatVector{data :  _ico_copysign_ps(self.data, v2.data)}
		}
	}
	...
	pub fn floor_to_int(self) -> IntVector{	
		unsafe{
			IntVector{data :  _mm_cvttps_epi32(self.floor().data)}
		}
	}
	...
	pub fn ceil_to_int(self) -> IntVector{	
		unsafe{
			IntVector{data :  _mm_cvttps_epi32(self.ceil().data)}
		}
	}
	...
	pub fn round_to_int(self) -> IntVector{	
		unsafe{
			IntVector{data :  _mm_cvttps_epi32(self.round().data)}
		}
	}
	...
	pub fn truncate_to_int(self) -> IntVector{	
		unsafe{
			IntVector{data :  _mm_cvttps_epi32(self.truncate().data)}
		}
	}
	...
	pub fn sqrt(self) -> FloatVector{	
		unsafe{
			FloatVector{data :  _mm_sqrt_ps(self.data)}
		}
	}
	...
	pub fn sin(self) -> FloatVector{	
		unsafe{
			FloatVector{data :  _ico_sin_ps(self.data)}
		}
	}
	...
	pub fn cos(self) -> FloatVector{	
		unsafe{
			FloatVector{data :  _ico_cos_ps(self.data)}
		}
	}
	...
	pub fn acos(self) -> FloatVector{	
		unsafe{
			FloatVector{data :  _ico_acos_ps(self.data)}
		}
	}
	...
	pub fn max(self, v2 : FloatVector) -> FloatVector{	
		unsafe{
			FloatVector{data : _mm_max_ps(self.data, v2.data)}
		}
	}
	...
	pub fn min(self, v2 : FloatVector) -> FloatVector{	
		unsafe{
			FloatVector{data : _mm_min_ps(self.data, v2.data)}
		}
	}
	...
	pub fn select(self, v2 : FloatVector, mask : bool) -> FloatVector{	
		...
		unsafe{
			FloatVector{data : _ico_select_ps(self.data, v2.data, 
	...
	pub fn lerp<T : Into<FloatVector>>(self, v2 : FloatVector, t : T) -> FloatVector{	
		unsafe{
			...
			FloatVector{data : _mm_fmadd_ps(v2.data, t_val, tmp)} //b * t + a
		}
	}
