...
#[inline(always)]
  ...
  pub fn and(self, v2 : Vector2Bool) -> Vector2Bool{  
    unsafe{
      return Vector2Bool{data : _mm_and_si128(self.data, v2.data)};
    }
  }
  ...
  pub fn or(self, v2 : Vector2Bool) -> Vector2Bool{ 
    unsafe{
      return Vector2Bool{data : _mm_or_si128(self.data, v2.data)};
    }
  }
  ...
  pub fn andnot(self, v2 : Vector2Bool) -> Vector2Bool{ 
    unsafe{
      return Vector2Bool{data : _mm_andnot_si128(self.data, v2.data)};
    }
  }
  ...
  pub fn xor(self, v2 : Vector2Bool) -> Vector2Bool{  
    unsafe{
      return Vector2Bool{data : _mm_xor_si128(self.data, v2.data)};
    }
  }
  #[inline(always)]
