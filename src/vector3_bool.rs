...
#[inline(always)]
  ...
  pub fn set(value : bool) -> Vector3Bool {
    ...
    unsafe{
    return Vector3Bool{data : _mm_set1_epi32(core::mem::transmute::<u32, i32>(val))};
    }
  }
  #[inline(always)]
  pub fn x(self) -> bool {
...
impl From<Vector2Bool> for Vector3Bool {
  #[inline(always)]
    fn from(v : Vector2Bool) -> Vector3Bool {
      unsafe{
        return Vector3Bool { data : _mm_castps_si128(_mm_movelh_ps(_mm_castsi128_ps(v.data), _mm_setzero_ps() )) };
      }
    }
}
