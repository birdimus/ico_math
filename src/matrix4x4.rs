...
impl Matrix4x4{
	...
	pub fn identity() -> Matrix4x4 {
		return Matrix4x4::new(1.0f32,0.0f32,0.0f32,0.0f32, 0.0f32,1.0f32,0.0f32,0.0f32, 0.0f32,0.0f32,1.0f32,0.0f32, 0.0f32,0.0f32,0.0f32,1.0f32);
	}
	...
	pub fn mul_vec(mat : Matrix4x4, v1 : Vector4) -> Vector4{	
		...
		unsafe{
			...
			return Vector4{data: _mm_fmadd_ps(mat.m[3], _wwww(v1.data),result)};
		}
	}
	...
	pub fn transform_vector(mat : Matrix4x4, v1 : Vector3) -> Vector4{	
		...
		unsafe{
			let mut result =			_mm_mul_ps(mat.m[0], _xxxx(v1.data));
			result =		 _mm_fmadd_ps(mat.m[1], _yyyy(v1.data),result);
			return Vector4{data: _mm_fmadd_ps(mat.m[2], _zzzz(v1.data),result)};
		}
	}
	...
	pub fn equals(a : Matrix4x4, b : Matrix4x4) -> bool{	
		unsafe{
			return 
					_mm_movemask_ps(_mm_cmpeq_ps(a.m[0], b.m[0]))  == 15 &&
