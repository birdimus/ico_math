...
impl IntVector{
	...
	pub fn new(value : i32) -> IntVector{
		unsafe{
			IntVector{data : _mm_set1_epi32(value)}
		}
	}
	#[inline(always)]
	pub fn zero() -> IntVector {
		unsafe{
			IntVector { data : _mm_setzero_si128() }
		}
	}
	#[inline(always)]
	...
	pub fn max(v1 : IntVector, v2 : IntVector) -> IntVector{	
		unsafe{
			IntVector{data : _mm_max_epi32(v1.data, v2.data)}
		}
	}
	...
	pub fn min(v1 : IntVector, v2 : IntVector) -> IntVector{	
		unsafe{
			IntVector{data : _mm_min_epi32(v1.data, v2.data)}
		}
	}
	#[inline(always)]
	pub fn abs(v1 : IntVector) -> IntVector{	
		unsafe{
			IntVector{data : _mm_abs_epi32(v1.data)}
		}
	}
	#[inline(always)]
	pub fn copysign(v1 : IntVector, v2 : IntVector) -> IntVector{	
		unsafe{
			IntVector{data : _mm_sign_epi32(v1.data, v2.data)}
		}
	}
	...
	*/
	...
	pub fn add(v1 : IntVector, v2 : IntVector) -> IntVector{	
		unsafe{
			IntVector{data : _mm_add_epi32(v1.data, v2.data)}
		}
	}
	...
	pub fn sub(v1 : IntVector, v2 : IntVector) -> IntVector{	
		unsafe{
			IntVector{data : _mm_sub_epi32(v1.data, v2.data)}
		}
	}
	#[inline(always)]
	pub fn mul(v1 : IntVector, v2 : IntVector) -> IntVector{	
		unsafe{
			IntVector{data : _mm_mullo_epi32(v1.data, v2.data)}
		}
	}
	...
	pub fn and(v1 : IntVector, v2 : IntVector) -> IntVector{	
		unsafe{
			IntVector{data : _mm_and_si128(v1.data, v2.data)}
		}
	}
	...
	pub fn or(v1 : IntVector, v2 : IntVector) -> IntVector{	
		unsafe{
			IntVector{data : _mm_or_si128(v1.data, v2.data)}
		}
	}
	...
	pub fn andnot(v1 : IntVector, v2 : IntVector) -> IntVector{	
		unsafe{
			IntVector{data : _mm_andnot_si128(v1.data, v2.data)}
		}
	}
	...
	pub fn xor(v1 : IntVector, v2 : IntVector) -> IntVector{	
		unsafe{
			IntVector{data : _mm_xor_si128(v1.data, v2.data)}
		}
	}
	...
	pub fn equal(v1 : IntVector, v2 : IntVector) -> IntVector{	
		unsafe{
			IntVector{data : _mm_cmpeq_epi32(v1.data, v2.data)}
		}
	}
	#[inline(always)]
	pub fn greater(v1 : IntVector, v2 : IntVector) -> IntVector{	
		unsafe{
			IntVector{data : _mm_cmpgt_epi32(v1.data, v2.data)}
		}
	}
	#[inline(always)]
	pub fn less(v1 : IntVector, v2 : IntVector) -> IntVector{	
		unsafe{
			IntVector{data : _mm_cmplt_epi32(v1.data, v2.data)}
		}
	}
...
impl From<FloatVector> for IntVector {
    ...
    fn from(v : FloatVector) -> IntVector {
    	unsafe{
        	return IntVector { data : _mm_cvttps_epi32(v.data) };
        }
    }
}
...
impl core::ops::Neg for IntVector {
	...
	fn neg(self) -> Self::Output {
		unsafe{
			return IntVector{data:_mm_sub_epi32(_mm_set1_epi32(0), self.data)};
		}
	}
}
